...
var showPlayedCardsForUser = function(n, valuesOfPlayedCards) {
    ...
    for (i = 0; i < valuesOfPlayedCards.length; i ++) {
        var playedCard = userPlayedCards.create(startX + i * globalVariables.scaledCardWidth / 4, startY, getCardName(valuesOfPlayedCards[i]));
        playedCard.width = globalVariables.scaledCardWidth;
        playedCard.height = globalVariables.scaledCardHeight;
    }
};

var toggleCardSelection = function(sprite) {
